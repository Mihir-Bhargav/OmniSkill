            ...
            <CardContent className="p-4 text-xs text-slate-700 dark:text-slate-300">
              ...
              <div className="mb-4">
                ...
                <div className="mt-3 p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg border border-indigo-200 dark:border-indigo-800">
                  <p className="text-xs font-semibold text-indigo-800 dark:text-indigo-200 mb-2">Start OmniSkill server</p>
                  <div className="bg-white dark:bg-slate-900 p-2 rounded font-mono text-xs border border-indigo-100 dark:border-indigo-800 text-slate-700 dark:text-slate-300">
                    python -m omniskill sse --skills-dir ./skills --port 3006
                  </div>
                  <p className="mt-2 text-xs text-indigo-700 dark:text-indigo-300">
                    Drop skill folders into <code className="bg-indigo-100 dark:bg-indigo-900 px-1 rounded">skills/</code> and call <code className="bg-indigo-100 dark:bg-indigo-900 px-1 rounded">omniskill__reload_skills</code> to pick them up live.
                  </p>
                </div>
              </div>
