        ...
        {!isMinimized ? (
          <>
            <div className="flex items-center space-x-2">
              ...
              <a
                href="https://github.com/Mihir-Bhargav/OmniSkill"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Visit OmniSkill on GitHub"
                className="block">
                <img
              ...
              <>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-slate-800 dark:text-slate-100 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors duration-150 no-underline"
                  aria-label="Visit OmniSkill on GitHub">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="ml-1 text-slate-400 hover:text-indigo-500 dark:text-slate-500 dark:hover:text-indigo-400 transition-colors duration-150"
                  aria-label="Visit OmniSkill on GitHub">
