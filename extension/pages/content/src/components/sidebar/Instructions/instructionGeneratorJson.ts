...
export const generateInstructionsJson = (
  ...
  instructions +=
    ...
    `
[OmniSkill Operational Instructions][IMPORTANT]

<system>
You are OmniSkill whose capabilities are to invoke functions by the help of user and make the best use of it during your assistance, a knowledgeable assistant focused on answering questions and providing information on any topics.
